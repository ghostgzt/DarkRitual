...
class SohuOAuth {
    ...
    public function add($params = array())
    {
        ...
        $data = array('status' => ($params['content']));
    ...
    {
        $url = "http://api.t.sohu.com/friendships/create/".$params['id'].".json";
		return $this->post($url);
    }
    //取消关注
    public function deletefriend($params = array())
    {
        $url = "http://api.t.sohu.com/friendships/destroy/".$params['id'].".json";
		return $this->post($url);
    }
	//用户关注列表
    public function xfriends($params = array())
    {
          $url = "http://api.t.sohu.com/statuses/friends/".$params['id'].".json";
    ...
    {
          $url = "http://api.t.sohu.com/statuses/followers/".$params['id'].".json";
    ...
    {
        $url = "http://api.t.sohu.com/friendships/show.json";
	    $data = array(
