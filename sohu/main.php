...
if($_GET['pp']){echo '<div class="pcount" style="display:none;">'.count($result).'</div>';echo '<!--';}
?>
<div>
...
<a id="xy" href="javascript:;" onclick="sethash('<?php echo $m;?>','<?php if(count($result)<$n){echo $p;}else{echo $p+1;}?>','<?php echo $n;?>','<?php echo $id;?>');xload('main.php?page=<?php if(count($result)<$n){echo $p;}else{echo $p+1;}?>&count=<?php echo $n;?>&mode=<?php echo $m;?>&id=<?php echo $id;?>');" >下一页</a>&nbsp;
...
<?php $i=0; foreach( $ids  as $id ): ?><?php if ($result[$i]['id']!='462768603'){echo $ids[$i].'|';}?><?php $i=$i+1; ?><?php endforeach; ?></div>
<?php endif;?>
