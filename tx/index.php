...
<meta name="description" content="腾讯微博互粉管理工具"/>
<meta name="keywords" content="腾讯,tqq,微博,腾讯微博,weibo,互粉,管理,工具"/> 
...
<div id="container">
	...
	<div class="left" id="main_left">
		...
		<h2>腾讯微博互粉管理工具<img src="../img/tx.png" width="20px" style="position:absolute;margin-top:-2px"><span style="font-size:14px;float:right;margin-top=-10px;"><a title="发微博" href="javascript:;" onclick="document.getElementById('xxs').innerHTML='';var dss=prompt('发送微博内容:','');if(dss){document.getElementById('xxs').innerHTML='正在发送...';
		  loadXMLDoc('update.php?mode=0&nr='+ b.encode(dss),'xxs',true);
		}" style="color:black;">发微博</a>&nbsp;<span id="xxs"></span>&nbsp;<a title="<?php echo $uinfo['name']; ?>" href="http://t.qq.com/<?php echo $uinfo['nick']; ?>" target="_black" style="color:black;"><?php echo $uinfo['nick'];?></a>/<a href="clearsessions.php" target="_top" title="退出登录" style="color:black;">退出登录</a></span></h2>
		<div id='index'>
<script>dehash('main.php');</script>
	...
	<div id="footer">
		...
		<span class="left">&copy; 2012-2013 <a title="作者主页" target="_blank" href="http://t.qq.com/GentleKwan/">腾讯微博互粉管理工具</a></span>
