...
if (isset($_GET['id'])){
require 'config.php';
$result  = $tx->addfriend(array('id' => $_GET['id']));
//var_dump($result['msg']);
if($result['msg']=='ok'){echo '关注成功<script>var xd=parent.document.getElementById(\'kd\');xd.innerHTML=parseInt(xd.innerHTML)+1;</script>';}else{echo '关注失败';}
}
?>
<script>
