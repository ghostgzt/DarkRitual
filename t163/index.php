...
<meta name="description" content="网易微博互粉管理工具"/>
<meta name="keywords" content="网易,t163,微博,网易微博,weibo,互粉,管理,工具"/> 
<meta name="author" content="天狼星の破晓,Gentle_Kwan"/> 
<link rel="shortcut icon" href="../img/t163.png"/>
...
<div id="container">
	...
	<div class="left" id="main_left">
		...
		<h2>网易微博互粉管理工具<img src="../img/t163.png" width="20px" style="position:absolute;margin-top:-2px" /><span style="font-size:14px;float:right;margin-top=-10px;"><a title="发微博" href="javascript:;" onclick="document.getElementById('xxs').innerHTML='';var dss=prompt('发送微博内容:','');if(dss){document.getElementById('xxs').innerHTML='正在发送...';
		  loadXMLDoc('update.php?mode=0&nr='+ b.encode(dss),'xxs',true);
		}" style="color:black;">发微博</a>&nbsp;<span id="xxs"></span>&nbsp;<a title="<?php echo $uinfo['description']; ?>" href="http://t.163.com/<?php echo $uinfo['screen_name']; ?>" target="_black" style="color:black;"><?php echo $uinfo['name'];?></a>/<a href="clearsessions.php" target="_top" title="退出登录" style="color:black;">退出登录</a></span></h2>
		<div id='index'>
<script>dehash('main.php');</script>
	...
	<div id="footer">
		...
		<span class="left">&copy; 2012-2013 <a title="作者主页" target="_blank" href="http://t.163.com/1138032747">网易微博互粉管理工具</a></span>
