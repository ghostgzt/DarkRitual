...
if (isset($_GET['id'])){
require 'config.php';
$result  = $sina->unfollow_by_id($_GET['id']);
if(!$result['following']){echo '清除成功<script>var xd=parent.document.getElementById(\'xd\');xd.innerHTML=parseInt(xd.innerHTML)+1;</script>';}else{echo '清除失败';}
}
?>
<script>
